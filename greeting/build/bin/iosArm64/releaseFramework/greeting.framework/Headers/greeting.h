...
@interface GreetingBase : NSObject
- (instancetype)init __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
+ (void)initialize __attribute__((objc_requires_super));
@end

@interface GreetingBase (GreetingBaseCopying) <NSCopying>
@end
...
@interface NSError (NSErrorGreetingKotlinException)
...
@interface GreetingGreetingKt : GreetingBase
